...
static fixed_pt load_avg;       /* System load average in fixed-point. */
...
init_thread (struct thread *t, const char *name, int priority)
{
  ...
  t->priority = priority;
  t->nice = 0;                          // initialize nice to 0
  t->recent_cpu = 0;                    // initialize recent_cpu to 0
